            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img src="{{ asset('storage/' . $image->image_url) }}" alt="Image" style="width: 100px; margin: 5px;">
                        @endforeach
                    </td>

                    <td>
                        <a href="{{ route('superadmin.portofolio.edit', $portfolio->id) }}" class="btn btn-warning">Edit</a>
                        <form action="{{ route('superadmin.portofolio.destroy', $portfolio->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus portofolio ini?');">
                            @csrf
                            @method('DELETE')
