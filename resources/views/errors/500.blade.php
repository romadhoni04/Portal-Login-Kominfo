...
<head>
    ...
    <meta name="description" content="Halaman Error 500 - Dasa Wisma Kabupaten Jepara" />
    <meta name="author" content="Diskominfo Jepara" />
    <title>500 - Kesalahan Server - Dasa Wisma Kabupaten Jepara</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="text-center mt-4">
                                <img class="img-fluid p-4" src="https://sb-admin-pro.startbootstrap.com/assets/img/illustrations/500-internal-server-error.svg" alt="500 - Kesalahan Server" />
                                <p class="lead">Server mengalami kesalahan internal atau konfigurasi yang salah dan tidak dapat menyelesaikan permintaan Anda.</p>
