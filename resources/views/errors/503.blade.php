...
<head>
    ...
    <meta name="description" content="Halaman Error 503 - Dasa Wisma Kabupaten Jepara" />
    <meta name="author" content="Diskominfo Jepara" />
    <title>503 - Layanan Tidak Tersedia - Dasa Wisma Kabupaten Jepara</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="text-center mt-4">
                                <img class="img-fluid p-4" src="https://sb-admin-pro.startbootstrap.com/assets/img/illustrations/503-error-service-unavailable.svg" alt="404 Error" style="max-width: 470px; height: auto;" />
                                <p class="lead">Server sementara tidak dapat melayani permintaan Anda karena pemeliharaan atau masalah kapasitas. Silakan coba lagi nanti.</p>
