...
<div class="container-fluid">
    ...
    <div class="text-center">
        ...
        <div class="error mx-auto" data-text="503">
        ...
        <p class="text-gray-500 mb-4">The server is currently unable to handle the request due to temporary overloading or maintenance of the server.</p>
