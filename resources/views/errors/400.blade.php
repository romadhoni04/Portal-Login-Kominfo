...
<head>
    ...
    <title>400 - Permintaan Tidak Valid - Dasa Wisma Kabupaten Jepara</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="text-center mt-4">
                                <img class="img-fluid p-4" src="https://sb-admin-pro.startbootstrap.com/assets/img/illustrations/400-error-bad-request.svg" alt="400 Error - Permintaan Tidak Valid" />
                                <p class="lead">Permintaan yang diajukan oleh klien Anda tidak valid atau tidak diizinkan.</p>
