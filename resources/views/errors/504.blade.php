...
<head>
    ...
    <meta name="description" content="Halaman Error 504 - Dasa Wisma Kabupaten Jepara" />
    <meta name="author" content="Diskominfo Jepara" />
    <title>504 - Gateway Timeout - Dasa Wisma Kabupaten Jepara</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="text-center mt-4">
                                <img class="img-fluid p-4" src="https://sb-admin-pro.startbootstrap.com/assets/img/illustrations/504-error-gateway-timeout.svg" alt="504 - Gateway Timeout" />
                                <p class="lead">Server mengalami kesalahan sementara dan tidak dapat menyelesaikan permintaan Anda. Silakan coba lagi nanti.</p>
